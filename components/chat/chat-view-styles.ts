...
export function getChatViewStyles(fontScale: number) {
  ...
  chromeFloat: { position: 'absolute', left: 0, right: 12, alignItems: 'flex-end', zIndex: 30, elevation: 6, top: 0 },
  chromeFloatButton: { width: 42, height: 42, borderRadius: 21, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
